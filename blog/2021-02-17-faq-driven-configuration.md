...
![A screenshot of Github code search. The author has typed 'what is listening on a port' into the code search against their dotfiles and found a matching file. The match isn't exactly what they typed in but close enough as if to suggest that searching for questions you've previously answered may be easier with this method.](./content/blog/faq-driven-configuration/search.png)

...
![A tightly cropped screenshot of the upper right corner of the Dropbox main view. The authors account is visible and the Settings button is highlighted.](./content/blog/dropbox-is-way-too-clingy/01-settings.png)

From the dropbown, click on Settings (**Second click**)

![A screenshot of the Dropbox account settings. There are a variety of radio buttons and tabs but the main item of interest is a link at the bottom titled "Delete account".](./content/blog/dropbox-is-way-too-clingy/02-inside-settings.png)
...
![Yet another page titled "Before you go, Marcus...", addressed to the author. It has a large blue button in the middle of the screen that reads "I changed my mind, take me back to Dropbox". There is another button for cancelling somewhere off screen that is not visible to the reader. The rest of the page just roughly lists the same claimed features as previous pages.](./content/blog/dropbox-is-way-too-clingy/06-final-screen.png)
...
![A tightly cropped screenshot of a green banner that reads "Account downgraded. Thanks for your feedback."](./content/blog/dropbox-is-way-too-clingy/07-done.png)
...
![A tightly cropped screenshot of a red banner that reads "You are scheduled to downgrade."](./content/blog/dropbox-is-way-too-clingy/08-banner.png)
...
![A form that says "Permanently delete your Dropbox account" with three inputs: one for your password, one for your reason for leaving and a third to enter in more details.](./content/blog/dropbox-is-way-too-clingy/09-delete.png)

Six[^3] more clicks to fill in this shitty form and that brings us up to **seventeen clicks** when I hit "Permanently delete"

![A tightly cropped screenshot of a black banner that reads "Your account has been deleted. We're sorry to see you go."](./content/blog/dropbox-is-way-too-clingy/10-free.png)

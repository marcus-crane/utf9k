...
---
About a year ago, I found myself learning more about film ratings than I ever cared to. At the time, I posted a [Bluesky thread](https://bsky.app/profile/utf9k.net/post/3lol5mmijqs23) but I still think it's a pretty fascinating bit of trivia so this is my attempt at a slightly more long-form version.
...
That rating almost usually looks like [one of these](https://www.fvlb.org.nz/media/3zfbpup2/ratings-and-classifcation-poster.pdf) stickers which older readers will recognise from physical media like DVDs, game boxes and so on but with streaming, they're less and less common. You may even spot them on movie posters, although I can't say I've personally looked too hard.

The [Film & Video Labelling Body](https://www.fvlb.org.nz/), or FVLB for short, is the Labelling Body for New Zealand that actually issues these labels.

Isn't that what the [Office of Film and Literature Classification](https://www.classificationoffice.govt.nz/) (OFLC) for, you might be thinking? I had assumed that too but the process is a lot more kafkaesque than you might imagine.

When it comes to films specifically, they are all submitted to the FVLB first who follow the process outlined on [page 2 of this document](https://www.fvlb.org.nz/media/uybdpq23/fvlb-info-sheet-effective-january-2021.pdf)
...
When it comes to videogame, they are actually [entirely exempt](https://www.classificationoffice.govt.nz/resources/items/our-guide-to-understanding-international-gaming-classifications/) from requiring labels unless they [contain restricted content](https://www.legislation.govt.nz/act/public/1993/94/en/2017-12-05/#DLM313427). They're still submitted to the FVLB but are then forwarded straight on to the OFLC.

Things get a bit more confusing when you realise that the Film and Video Labelling Body happens to be the [current labelling body](https://www.legislation.govt.nz/act/public/1993/94/en/2017-12-05/#DLM313839) but technically could be replaced by some other entity entirely, if the Minister for Internal Affairs decided for whatever reason.

The FVLB is an [incorporated society](https://register.charities.govt.nz/CharitiesRegister/ViewCharity?accountId=083dcb5c-b4c8-dc11-8026-0015c5f3da29) and they've been strugging since 2016 for a couple of reasons.[^3]
...
The second, and probably worse issue, are the [various streaming platforms](https://www.legislation.govt.nz/act/public/1993/94/en/latest/#DLM3535310) (Netflix/Disney+/Amazon Prime Video etc).

In order to speed up their ability to import content, and to avoid flooding the FVLB/OFLC, [most streaming providers are allowed to perform their own self-rating of content](https://www.classificationoffice.govt.nz/resources/items/so-youve-launched-a-streaming-service-in-new-zealand/#self-rating), which also means that the FVLB does not receive any fees. They do have to pay an annual levy to the [OFLC](https://legislation.govt.nz/act/public/1993/94/en/latest/#LMS408285) however.
...
As part of this rabbit hole, I [asked the Department of Internal Affairs](https://fyi.org.nz/request/30057-information-about-the-financial-health-of-the-fvlb-during-the-covid-era) for documents about the financial health of the FVLB so we can actually tell the rest of the story in their words.
...
A July 2021 memo titled "Film and Video Labelling Body funding" [outlined](https://fyi.org.nz/request/30057/response/121594/attach/5/OIA2425%200776%20Marcus%20via%20FYI%20Appendix%20A.pdf#Page=5) what the Department of Internal Affairs seemed to view as the only real option:
...
[^1]: By which I mean, I did some runs during covid but I have absolutely no stamina so I could never go more than a couple of kilometres. It's really hard to pace yourself!

[^2]: It's a great way to learn stuff by skimming other people's OIAs, and the underlying idea was to get inspiration on what novel things I could ask for.

[^3]: You can view their financial statements on the [Charities Register](https://register.charities.govt.nz/CharitiesRegister/ViewCharity?accountId=083dcb5c-b4c8-dc11-8026-0015c5f3da29) but it's also mentioned [here on Page 2](https://fyi.org.nz/request/30057/response/121594/attach/5/OIA2425%200776%20Marcus%20via%20FYI%20Appendix%20A.pdf#Page=2): "The FVLB advised it has been recording deficits since 2016."

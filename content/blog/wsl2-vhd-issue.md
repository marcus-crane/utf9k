...
Long story short, I dove in by following the [installation instructures] and hit a brick wall once I got to the second step.
...
The terms "uncompressed and unencrypted" tipped me off to check those blasted "advanced settings". Under `General > Advanced`, I spotted `Compress contents to save disk space` was ticked for some reason. Unchecking it, then rerunning the WSL 1 -> 2 conversion then worked as you'd hope.

{{< img "/img/wsl2-vhd-issue/compressed.png" >}}

...
These were the only photos in the set that I recall seeing and they really drove it home that beyond the potential for identity fraud, who knows how many compromising and/or embarrassing photos that patients have submitted to their GPs in confidence.
...
It gave a wide-ranging overview of her career, and most recently talked about how she thought she was valued, only for her employer to seemingly go behind her back in trying to find a replacement.
...
Thinking that they were both Saudi-Icon related, I downloaded both. Sure enough, one of them was a set of files that seemed architectural in nature but to my surprise, the second was a further set of 182 documents that appeared to be related to ManageMyHealth.
...
They would either need to have some sort of index that they could iterate through or they obtained access to a set of object storage credentials that had permission to both list and fetch objects.
...
[^versions]: ManageMyHealth are a New Zealand company but they also spun up [Australian](https://public.managemyhealth.com.au/) and [Indian](https://managemyhealth.in/) versions of the software.

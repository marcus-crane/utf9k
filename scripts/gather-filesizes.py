...
exclude = set(['_components', 'src/data', '_includes', '_scripts', '_site', 'resources', 'public', 'node_modules', '.github', '.cache', '.git', '.DS_Store', 'venv', '.venv'])
file_metadata = []
...
with open('src/data/filesizes.json', 'w') as file:

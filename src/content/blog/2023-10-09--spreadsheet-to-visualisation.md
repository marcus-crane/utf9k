...
![A screenshot of an Excel spreadsheet. There are many workbooks which each contain data for a specific year between 2016 and 2019. The data is formatted visually but will be a huge pain to access programmatically.](../../../assets/img/blog/2023-10-09--spreadsheet-to-visualisation/spreadsheet.png)
...
![A screenshot of the LINZ Data Service, a web browser for viewing map layers and other types of data sets. In this image, the NZ Addresses dataset is selected and partly visible on the right side of the screen. On the left side is the LDS data set browser.](../../../assets/img/blog/2023-10-09--spreadsheet-to-visualisation/lds.png)
...
![A Mapbox map layer showing Newmarket, Auckland, New Zealand. There are two numbered points on opposite sides of the map with a line going straight from one to the other.](../../../assets/img/blog/2023-10-09--spreadsheet-to-visualisation/map-direct.png)
...
![A Mapbox map layer showing Newmarket, Auckland, New Zealand. There are many numbered points, each at main intersections of the map with lines joining between them. It roughly follows the path that a car might drive.](../../../assets/img/blog/2023-10-09--spreadsheet-to-visualisation/map-points.png)
